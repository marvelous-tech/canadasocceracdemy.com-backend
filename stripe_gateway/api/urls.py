...
from stripe_gateway.api.views import create_another_payment_method, make_default_api_view, \
    attempt_adding_payment_method, card_declined
...
urlpatterns = [
    ...
    path('declined/', card_declined, name="DECLINED"),
]
